...
- name: Devin Judge-Lord
  ...
  footnote: "I will be grateful for any feedback on this early draft: [DevinJudgeLord@fas.harvard.edu](mailto:DevinJudgeLord@fas.harvard.edu). Slides and the most recent draft are available at <https://judgelord.github.io/research/cj>. This paper has benefited from funding from the National Science Foundation and American Political Science Association."
  # Additional tables, figures, and replication code are available at <https://judgelord.github.io/dissertation/cj-appendix.html>. 
date: "`r Sys.Date()`"
abstract: | 
