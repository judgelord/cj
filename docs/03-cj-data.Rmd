...
```{r cj-data-agencies, out.width = "100%"}
knitr::include_graphics(here::here("Figs/cj-data-agencies-2.png"))
```

##Measuring Public Pressure and Political Information {#why-methods}
